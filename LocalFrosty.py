...
# HTML and CSS for applying a solid color to the title
solid_color_text_html = """
<style>
.title-text {
    font-weight: bold;  /* Keeps the text bold */
    color: #197A56;    /* Sets the color of the text */
    font-size: 3em;    /* Adjusts the size of the text */
}
</style>
<div class="title-text">☃️ Frosty</div>
"""

st.markdown(solid_color_text_html, unsafe_allow_html=True)
